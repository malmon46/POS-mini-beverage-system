...
<form action="buy.php" method="Post" name ="frmMain1">
<br>
<font  color = "dimgray"><b><h3>Purchase Beverage</h3></b></font>
<font color = 'dimgray'>
Search:&nbsp;&nbsp;
</font>
	...
	while($row = mysql_fetch_array($result3))
		{
			  ...
			  echo '<td><a href=buy1.php?product_no='.$row["product_no"].'><input type="button" value="Purchase Beverage" id = "buttons" title = "Purchase Beverage">'.'</a></td>';
			  echo'<tr>';
